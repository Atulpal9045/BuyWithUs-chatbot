...
var PayloadPanel = (function() {
    ...
    function togglePanel(event, element) {
        var chatColumn = document.querySelector('#chat_column')
        var chatIcon = document.querySelector('#chat_icon');
        if (chatColumn.classList.contains('chat-active')) {
            chatColumn.classList.remove('chat-active');
            chatIcon.style.color = "white";
        } else {
            chatColumn.classList.add('chat-active');
            chatIcon.style.color = "rgb(47 196 156)";
        }
    }
